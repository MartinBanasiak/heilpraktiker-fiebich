...
$cspValue =
    "connect-src 'self' ws://127.0.0.1:35729 *.trustindex.io *.googleapis.com;" . // XMLHttpRequest (AJAX request), WebSocket or EventSource.
    ...
    "font-src 'self' data: *.trustindex.io *.googleapis.com *.gstatic.com *.youtube.com *.facebook.com *.facebook.net *.google-analytics.com *.googletagmanager.com *.typekit.net *.google.com *.google.de stats.g.doubleclick.net ;" . //For the FONT
    ...
    "img-src 'self' data: https://*.amazon.com *.trustindex.io *.ssl-images-amazon.com https://*.payments-amazon.com  https://*.google-analytics.com https://d23yuld0pofhhw.cloudfront.net *.googleapis.com *.gstatic.com *.youtube.com *.facebook.com *.facebook.net *.google-analytics.com *.googletagmanager.com *.typekit.net *.google.com *.google.de *.jameda-elements.de *.goyellow.de stats.g.doubleclick.net ;" . // img-src
    "frame-src 'self' " . $allowedWebSites . " *.dr-schmiedel.de *.jameda.de *.google.com *.youtube.com;" . // vaid sources for frames
    "object-src 'none'; " . // valid object embed and applet tags src
    "script-src 'self' 'unsafe-eval' 'unsafe-inline' " . $domainName . " *.trustindex.io *.docplanner.com *.ssl-images-amazon.com *.amazon.com  *.payments-amazon.com *.googleapis.com *.gstatic.com *.youtube.com *.facebook.com *.facebook.net *.google-analytics.com *.googletagmanager.com *.typekit.net *.google.com *.google.de *.jameda-elements.de stats.g.doubleclick.net ;" . // allows js from self, jquery and google analytics.  Inline allows inline js
    "style-src 'self' 'unsafe-inline' *.trustindex.io *.googleapis.com *.gstatic.com *.youtube.com *.facebook.com *.facebook.net *.google-analytics.com *.googletagmanager.com *.typekit.net *.google.com *.google.de stats.g.doubleclick.net ;";// allows css from self and inline allows inline css
