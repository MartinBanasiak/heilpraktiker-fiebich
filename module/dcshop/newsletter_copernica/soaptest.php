<pre><?php
    ...
    try {
        ...
        /// $url = "http://mailing.dc-solution.de";
        $url = "http://mailing.dc-solution.de";
        ...
        // show what we are doing
        if ($verbose) {
            echo("create collection children\n");
        }
