...
?>
<div class="info_button_facebook sharing">
    <a href="#" data-toggle="modal" data-target="#inlineContent_fb" onclick="load_fb();"><?= $GLOBALS["tc"]["share_on_facebook"] ?> <i class="fa fa-facebook-square" aria-hidden="true"></i></a>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-headline"><?= $GLOBALS["tc"]["share_on_facebook"] ?></div>
