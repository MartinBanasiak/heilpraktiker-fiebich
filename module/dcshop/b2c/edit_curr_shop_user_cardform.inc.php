...
<form id="<?= $formname ?>" name="<?= $formname ?>" method="post" class="form-label-left">
    <div class="row">
        <div class="col-xs-12 col-sm-8 col-lg-6">
            ...
            <? input_shop($GLOBALS["tc"]["password"], "input_password", "password", 'nochange', 30)  ?>
            <? input_shop($GLOBALS["tc"]["password_2"], "input_password_2", "password",'nochange', 30) ?>
