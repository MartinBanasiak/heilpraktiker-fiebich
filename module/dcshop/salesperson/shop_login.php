...
<?php
require_once rtrim(dirname(dirname(dirname(__DIR__))),'/\\') . DIRECTORY_SEPARATOR . 'dc/common/version_comment.inc.php';
require_once rtrim(dirname(dirname(dirname(__DIR__))),'/\\') . DIRECTORY_SEPARATOR . 'common/common_functions.inc.php';
?>
<head>
...
<div id="spacer_1"><a href="javascript:void(0);"
                      onclick="toggleOn('login_content_3');toggleOff('login_content_1');toggleOff('login_content_2');">Impressum</a>
</div>
<div id="spacer_2"></div>
<div id="spacer_3"></div>
