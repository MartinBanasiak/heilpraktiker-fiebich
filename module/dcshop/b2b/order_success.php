...
if ($terms['checkout'] == "4" || $terms['checkout'] == "5") {
    headerFunctionBridge('Location: https://' . $_SERVER["SERVER_NAME"] . '/' . $_SESSION['site_code'] . '/' . $_SESSION['language_code'] . '/order/complete_order/');
} else {
    ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            parent.location.href = 'https://<?=$_SERVER["SERVER_NAME"]?>/<? echo customizeUrl(); ?>/order/complete_order/';
            self.close();
        </script>
