...
/**
 * Class ShipmentAddressCollection
 */
class ShipmentAddressCollection implements GenericCollectionInterface {
    ...
    /**
     * @return ShipmentAddressCollection
     */
     ...
     * @return bool
     */
    protected function _addShipmentAddress( ShipmentAddress $shipmentAddress, $idCheck = FALSE ) {
        return $this->_add($shipmentAddress, $idCheck);
    }
     ...
     * @return bool
     */
    protected function _removeShipmentAddress( ShipmentAddress $shipmentAddress, $idCheck = FALSE ) {
        return $this->_remove($shipmentAddress,$idCheck);
    }
