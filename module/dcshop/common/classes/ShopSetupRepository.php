 ...
 * Time: 11:24
 */
class ShopSetupRepository implements Repository {

    use genericRepositoryTrait;

    /**
     * @param GenericDBQueryWrapperInterface                     $db
     * @param ModelDBConfigInterface|ShopSetupConfig                $config
     * @param CriteriaHelperInterface $criteriaValidationService
     * @param \DynCom\dc\common\interfaces\GenericCollectionInterface|ShopSetupCollection        $collection
     * @param                                                    $cacheAll
     */
