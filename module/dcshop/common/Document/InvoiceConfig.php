 ...
 * Time: 11:19
 */
class InvoiceConfig implements DocumentModelDBConfigInterface {

    use documentConfigTrait;

    protected $modelClassName = 'DynCom\dc\dcShop\Document\InvoiceDocument';
    protected $tableName      = 'shop_sales_invoice_header';
    protected $baseTableName  = 'shop_sales_invoice_header';
    ...
    protected $linesClassName             = 'InvoiceLine';
