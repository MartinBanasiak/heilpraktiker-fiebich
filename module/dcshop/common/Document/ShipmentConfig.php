...
class ShipmentConfig implements DocumentModelDBConfigInterface
{
    ...
    protected $modelClassName = 'DynCom\dc\dcShop\Document\ShipmentDocument';
    ...
    protected $mappedFields = array(
        ...
        array('name' => 'marketplace_update', 'type' => 'TINYINT'),
        array('name' => 'tracking_no', 'type' => 'VARCHAR'),
        array('name' => 'tracking_link', 'type' => 'VARCHAR'),
