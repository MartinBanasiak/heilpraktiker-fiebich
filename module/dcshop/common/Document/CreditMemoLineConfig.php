 ...
 * Time: 11:20
 */
class CreditMemoLineConfig implements DocLineModelDBConfigInterface {

    use genericConfigTrait;

    protected $modelClassName = 'DynCom\dc\dcShop\Document\CreditMemoLine';
    protected $tableName      = 'shop_cr_memo_line';
    protected $baseTableName  = 'shop_cr_memo_line';
    protected $docClassName   = 'CreditMemoDocument';
