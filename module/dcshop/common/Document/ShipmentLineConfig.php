...
class ShipmentLineConfig implements DocLineModelDBConfigInterface {

    use genericConfigTrait;

    protected $modelClassName = 'DynCom\dc\dcShop\Document\ShipmentLine';
    protected $tableName      = 'shop_sales_shipment_line';
    protected $baseTableName  = 'shop_sales_shipment_line';
    protected $docClassName   = 'ShipmentDocument';
