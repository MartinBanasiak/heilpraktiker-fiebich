 ...
 */
class NavOrderDocument implements \IteratorAggregate, \Countable, GenericDocumentInterface, PrintableDocumentInterface
{
    ...
    Public const DOCUMENT_TYPE = "NAV_CONTRACT";
