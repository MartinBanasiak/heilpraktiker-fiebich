 ...
 * Time: 11:22
 */
class NavOrderLineConfig implements DocLineModelDBConfigInterface {

    use genericConfigTrait;

    protected $modelClassName = 'DynCom\dc\dcShop\Document\NavOrderLine';
    protected $tableName      = 'shop_nav_sales_line';
    protected $baseTableName  = 'shop_nav_sales_line';
    protected $docClassName   = 'NavOrderDocument';
    protected $altPrimary     = array('company','document_no','line_no');
    protected $mappedFields   = array(
        array('name' => 'id','type' => 'INT'),
        array('name' => 'company','type' => 'VARCHAR'),
        array('name' => 'document_type','type' => 'TINYINT'),
