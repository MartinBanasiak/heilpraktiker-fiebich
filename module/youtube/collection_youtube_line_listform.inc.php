...
<form id="<?= $formname ?>" name="<?= $formname ?>" method="post">
    ...
    <table class="cardform" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td>
                <?php input($translation->get("element_width"), "module_input_youtube_width_" . $fieldSetup['id'], "code", $width) ?>
            </td>
            <td>
        ...
        <tr>
            <td>
                <?php input($translation->get("element_height"), "module_input_youtube_height_" . $fieldSetup['id'], "code", $height) ?>
            </td>
            <td>
