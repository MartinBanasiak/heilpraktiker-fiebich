...
$formname            = "form_line_magicscroll_list_" . $fieldSetup['id'];
$inputname           = "input_id";
...
<form id="<?= $formname ?>" name="<?= $formname ?>" method="post">
    ...
    $query = "SELECT id, preview AS '" . $translation->get("preview") . "', description AS '" . $translation->get("description") . "', link AS '" . $translation->get("link") . "' FROM scrollbar_line WHERE header_id = " . $row['main_sitepart_header_id'] . " ORDER BY sorting ASC";
