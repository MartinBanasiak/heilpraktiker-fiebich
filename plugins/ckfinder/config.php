...
$config['authentication'] = function () {
    if(array_key_exists('IsAuthorized',$_SESSION) && $_SESSION['IsAuthorized']) {return true;}


    if(	(isset($shop_password) && isset($_GET["pass"]) && $_GET["pass"] == $shop_password)){
        return true;
    }
...
$config['licenseName'] = 'dynamic commerce GmbH';
$config['licenseKey']  = 'BFKH-GCPJ-872M-Y96V-RDWT-WZ9Z-H2EJ';
...
$config['resourceTypes'][] = Array(
    ...
    'maxSize' => 0,
    'allowedExtensions' => 'css,gif,jpeg,jpg,png,ico,svg,xml,js',
    'deniedExtensions' => '',
    'absoluteUrl' => '/layout/frontend',
    'backend'           => 'dc');
